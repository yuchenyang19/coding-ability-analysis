...
s11 = open('../data/commitTimesRank.json')
res11 = s11.read()
data11 = json.loads(res11)

s12 = open('../data/scoreRatesRank.json')
res12 = s12.read()
data12 = json.loads(res12)

s21 = open('../data/scoreRank.json')
res21 = s21.read()
data21 = json.loads(res21)

s22 = open('../data/eachTypeCompleteRate.json')
res22 = s22.read()
data22 = json.loads(res22)

s23 = open('../data/allTestsCompleteRate.json')
res23 = s23.read()
...
fDataCollect = open('../data/dataCollect.json', 'w')
